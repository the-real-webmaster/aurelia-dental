  ...
  return `
      <div class="ba ba--premium" data-ba tabindex="0" role="slider" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" aria-label="Сравнение до и после лечения"${extraAttrs}>
        <div class="ba__layer ba__layer--before">
          <img src="assets/images/before-after-before.webp" alt="Улыбка до эстетического лечения" width="1200" height="900" loading="lazy" decoding="async">
        </div>
        <div class="ba__layer ba__after">
          <img src="assets/images/before-after-after.webp" alt="Улыбка после эстетического лечения" width="1200" height="900" loading="lazy" decoding="async">
        </div>
